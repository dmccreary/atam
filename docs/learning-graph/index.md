# Learning Graph for The Right Database
...
This learning graph contains **254 concepts** across **16 topic categories** with **455 dependency edges**,
covering the ATAM methodology, six database paradigms, distributed systems, ACID transactions,
high availability, vector search, LLM embeddings, and database selection frameworks.
...
- A concept classifier taxonomy with 16 categories
- Category organization — foundational elements first, selection frameworks last
- Balanced categories (4.7%–8.7% each)
