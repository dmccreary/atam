...
description: 'An interactive intelligent textbook on software architecture tradeoff analysis.'
image: img/cover.png
---
...
<figure markdown>
  ![Architecture Tradeoff Analysis Method cover](./img/cover.png){ width="100%" }
</figure>

An interactive intelligent textbook on software architecture tradeoff analysis.
